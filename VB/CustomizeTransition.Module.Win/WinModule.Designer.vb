Namespace CustomizeTransition.Module.Win
    Partial Public Class CustomizeTransitionWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' CustomizeTransitionWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(CustomizeTransition.Module.CustomizeTransitionModule))
