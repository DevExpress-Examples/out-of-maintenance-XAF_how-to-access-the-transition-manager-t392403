...
Namespace CustomizeTransition.Win
    ...
    Partial Public Class CustomizeTransitionWindowsFormsApplication
        ...
        End Sub
        Private Sub CustomizeTransitionWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
            ...
            End If
        End Sub
        Private Sub CustomizeTransitionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
